                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr v-for="(info, index) in get_payresult" v-show="setPaginate(index)" :key="index">
                                            ...
                                            <td>{{ info.pay_name}}</td>
                                            <td>
                                                <a v-if="info.auth_name == '승인' && info.terminal_name == '사용자online'" @click="cancel(index,info.seq_no,info.auth_no,info.pay_fee, info.trno)">[승인취소]</a>
                                                <a v-else-if="info.auth_name == '승인' && info.terminal_name == 'Kiosk'" @click="cancel01(info.seq_no)">[취소]</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
