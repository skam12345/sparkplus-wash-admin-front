                ...
                <div class="contents">
                    ...
                    <div class="contents_area MT40">
                        <div class="contents_area-table product_inquire">
                            ...
                            <div class="contents_area-queue" style="width:70% ;float:left;">
                                <div v-for="(info,index) in get_washCar" :key="index" style="margin:0 auto; margin-top : 40px;">
                                    <div>
                                        <p>{{info.car_no}}</p>
                                        <ul class="process">
                            ...
                            <div style="width:30%;float:right;margin-top : 40px; border : 2px solid orange;">
