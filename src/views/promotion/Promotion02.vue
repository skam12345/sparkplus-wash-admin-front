                        ...
                        <div class="contents_area">
                            ...
                            <div class="contents_area-table">
                                ...
                                <p class="fl_right" style="width:500px;">
                                   사은품 QR :  <input type="text" name="text" size="20" placeholder="쿠폰번호 입력" v-model ="coupon_number" style="width:63%; margin-right: 3px;" >
                                     <button type="button" class="btn_add btn_red" @click="register_qrcoupon">사용 처리</button>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr v-for="(info, index) in get_couponresult" :key="index">
                                            <td class="right">{{ get_couponsum.account_coupon - index_no-index }}</td>
                                            ...
                                            <td>{{ info.reg_date}}</td>
                                            <td><span v-if="info.use_date == '1900-01-01'">--</span>
            ...
            methods : {
                get_search(){
                    ...
                    ,{headers : {
                        ...
                        this.paginate_total = Math.ceil(this.get_couponsum.account_coupon/this.paginate)
                    })
                ...
                register_qrcoupon(){
                    this.$http.post(this.$server+'/admin/setCouponUse',
                    {
